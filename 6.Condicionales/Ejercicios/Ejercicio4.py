...
por el cual votar. Las posibilidades son: candidato A por el partido 
rojo, candidato B por el partido verde, candidato C por el partido azul.
...
elegido]”. Si el usuario ingresa una opción que no corresponde a ninguno
...
opcion = input("Ingresa la opcion de tu candidato (ABóC): ")
